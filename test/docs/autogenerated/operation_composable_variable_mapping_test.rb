...
class CVOutTest < Minitest::Spec
  ...
  it "Out() can limit" do
    ...
    assert_invoke Song::Operation::Create, current_user: Module, expected_ctx_variables: {model: Object, message: nil}
    #= policy breach, {message_from_policy} set.
    assert_invoke Song::Operation::Create, current_user: nil, terminus: :failure, expected_ctx_variables: {model: Object, message: "Command {create} not allowed!"}
  end
...
class CVOutHashTest < Minitest::Spec
  ...
  it "Out() can map" do
    #= policy didn't set any message
    assert_invoke Song::Operation::Create, current_user: Module, expected_ctx_variables: {model: Object, message_from_policy: nil}
    #= policy breach, {message_from_policy} set.
    assert_invoke Song::Operation::Create, current_user: nil, terminus: :failure, expected_ctx_variables: {model: Object, message_from_policy: "Command {create} not allowed!"}
  end
end
...
class CVOutOuterTest < Minitest::Spec
  ...
  it "Out() with {outer_ctx}" do
    #= policy didn't set any message
    assert_invoke Song::Operation::Create, current_user: Module, errors: {}, expected_ctx_variables: {:errors=>{:policy_message=>nil}, model: Object, message: nil}
    #= policy breach, {message_from_policy} set.
    assert_invoke Song::Operation::Create, current_user: nil, errors: {}, terminus: :failure, expected_ctx_variables: {:errors=>{:policy_message=>"Command {create} not allowed!"}, :model=>Object, :message=>"Command {create} not allowed!"}
  end
end
    ...
    def self.Create()
      {
        task: Policy::Create,
        wrap_task: true,
        Trailblazer::Operation::Railway.In()  => {:current_user => :user},
        Trailblazer::Operation::Railway.In()  => [:model],
        Trailblazer::Operation::Railway.Out() => {:message => :message_from_policy},
      }
    end
  end
  #:macro end
...
class CVMacroMergeTest < Minitest::Spec
  ...
  it do
    #= policy didn't set any message
    assert_invoke Song::Operation::Create, current_user: Module, expected_ctx_variables: {model: Object, message_from_policy: nil, :copied_message=>nil}
    #= policy breach, {message_from_policy} set.
    assert_invoke Song::Operation::Create, current_user: nil, terminus: :failure, expected_ctx_variables: {model: Object, :message_from_policy=>"Command {create} not allowed!", :copied_message=>"Command {create} not allowed!"}
  end
end
...
class CVInheritanceTest < Minitest::Spec
  ...
  module Song::Operation
    class Create < Trailblazer::Operation
      extend Trailblazer::Operation::DSL::Linear::VariableMapping::Inherit # this has to be done on the root level!
...
=begin
#:sub-pipe
puts Trailblazer::Developer::Render::TaskWrap.(Song::Operation::Admin, id: :policy)

Song::Operation::Admin
# `-- policy
#     |-- task_wrap.input..................Trailblazer::Operation::DSL::Linear::VariableMapping::Pipe::Input
#     |   |-- input.init_hash.............................. ............................................. VariableMapping.initial_aggregate
#     |   |-- input.add_variables.0.994[...]............... {:current_user=>:user}....................... VariableMapping::AddVariables
...
=end
  ...
  it do
    #= policy didn't set any message
    assert_invoke Song::Operation::Admin, current_user: Module, expected_ctx_variables: {model: Object, message: nil, :raw_message_for_admin=>nil}
    assert_invoke Song::Operation::Admin, current_user: nil, terminus: :failure, expected_ctx_variables: {model: Object, :message=>"Command {create} not allowed!", :raw_message_for_admin=>"Command {create} not allowed!"}
  end
end
...
class CVInjectTest < Minitest::Spec
  ...
  it "Inject()" do
    ...
    assert_invoke Song::Operation::Create, current_user: Module, action: :create, expected_ctx_variables: {model: Object}

    #= {:action} set explicitely to {:update}, policy breach
    assert_invoke Song::Operation::Create, current_user: Module, action: :update, expected_ctx_variables: {model: Object, message: "Command {update} not allowed!"}, terminus: :failure
  end
end
...
class CVNoInjectTest < Minitest::Spec
  ...
  it "not using Inject()" do
    ...
    assert_invoke Song::Operation::Create, current_user: Module, expected_ctx_variables: {model: Object, message: "Command {} not allowed!"}, terminus: :failure
...
class InInjectSortingTest < Minitest::Spec
  it do
    activity = Class.new(Trailblazer::Operation::Railway) do
      step :params,
        Inject()  => [:params],
        In()      => ->(ctx, **) { {params: {id: 1}}  }
