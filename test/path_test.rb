...
#<End/:success>
  ...
  it "accepts {:track_name}" do
    state = Activity::Path::DSL::State.build(**Activity::Path::DSL.OptionsForState(track_name: :green))
    seq = state.step task: implementing.method(:f), id: :f
    seq = state.step task: implementing.method(:g), id: :g
...
#<End/:success>
  ...
  it "accepts {:end_task}" do
    state = Activity::Path::DSL::State.build(**Activity::Path::DSL.OptionsForState(end_task: Activity::End.new(semantic: :winning), end_id: "End.winner"))
    seq = state.step task: implementing.method(:f), id: :f
    seq = state.step task: implementing.method(:g), id: :g
