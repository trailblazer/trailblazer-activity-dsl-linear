...
class VariableMappingUnitTest < Minitest::Spec
  ...
  describe "SetVariable" do
    it "SetVariable#call can invoke a {Circuit.Step}" do
      ...
      pipe_task = Trailblazer::Activity::DSL::Linear::VariableMapping::SetVariable.new(:model, filter, user_filter)
    ...
    it "SetVariable#call can invoke any self-made circuit-step interface filter" do
      ...
      pipe_task = Trailblazer::Activity::DSL::Linear::VariableMapping::SetVariable.new(:model, my_lowlevel_inject_filter, my_lowlevel_inject_filter)
