...
#<End/:failure>
  ...
  # c --> pass_fast
      signal, (ctx,) = process.to_h[:circuit].([{seq: [], c: Trailblazer::Activity::FastTrack::PassFast}])
  ...
  # c --> fail_fast
      signal, (ctx,) = process.to_h[:circuit].([{seq: [], c: Trailblazer::Activity::FastTrack::FailFast}])
