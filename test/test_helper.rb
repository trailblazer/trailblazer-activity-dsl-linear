...
Trailblazer::Core.convert_operation_test("test/docs/sequence_options_test.rb", target: "../trailblazer-operation/test/docs/autogenerated/sequence_options_test.rb")
