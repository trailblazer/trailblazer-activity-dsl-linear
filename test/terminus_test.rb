...
class TerminusTest < Minitest::Spec
  it "#terminus allows adding end events" do
    ...
    assert_equal CU.inspect(Trailblazer::Activity::Introspect.Nodes(activity, id: "End.not_found").data), %{{:id=>\"End.not_found\", :dsl_track=>:terminus, :stop_event=>true, :semantic=>:not_found}}
    assert_equal CU.inspect(Trailblazer::Activity::Introspect.Nodes(activity, id: "End.found_it!").data), %{{:id=>\"End.found_it!\", :dsl_track=>:terminus, :stop_event=>true, :semantic=>:found_it}}
    assert_equal CU.inspect(Trailblazer::Activity::Introspect.Nodes(activity, id: "End.found").data), %{{:id=>\"End.found\", :dsl_track=>:terminus, :stop_event=>true, :semantic=>:found}}
