module Trailblazer
  class Activity
    module DSL
      module Feature
        module TaskWrap # this could be something like "Extension"
          ...
          module Normalizer
            ...
            # compiled step.
            def self.apply_adds_for_task_wrap_pipeline(ctx, flow_options, _, task_wrap_pipeline:, adds_for_task_wrap:, **)
            ...
            Node = Circuit::Node[method(:apply_adds_for_task_wrap_pipeline), Circuit::Task::Adapter::LibInterface]
          end
        end # TaskWrap
      end
    end
